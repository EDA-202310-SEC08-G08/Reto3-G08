...
# Challenge Template
<!-- PROJECT SHIELDS -->
[![Contributors][challenge3-contributors-shield]][challenge3-contributors-url]
[![Forks][challenge3-forks-shield]][challenge3-forks-url]
[![Stargazers][challenge3-stars-shield]][challenge3-stars-url]
[![Issues][challenge3-issues-shield]][challenge3-issues-url]
[![License][challenge3-license-shield]][challenge3-license-url]

The third project focuses on the use of the ADT Ordered Maps, mainly the Binary Search Tree (BST) and the Red-Black Tree (RBT). It also integrates the use of all previous ADTs (i.e.: List, Stack, Queue and Map).
